 ...
 * due to [ACL constraints](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#securityFiltering).
 *
 * source: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#pathsObject
 */
export interface Paths {
   ...
   * paths with the same hierarchy but different templated names MUST NOT exist as they are
