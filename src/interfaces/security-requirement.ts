 ...
 *
 * When a list of Security Requirement Objects is defined on the Open API object or Operation
 * Object, only one of Security Requirement Objects in the list needs to be satisfied to
 * authorize the request.
 *
 * source: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#securityRequirementObject
 */
export interface SecurityRequirement {
   ...
   * then the value is a list of scope names required for the execution. For other security scheme
