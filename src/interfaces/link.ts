 ...
 * operation.
 * 
 * source: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#linkObject
 */
export interface Link {
   ...
   * used to locate an existing Operation Object in the OpenAPI definition.
   */
  operationRef?: string;
  /**
   ...
   * be a constant or an expression to be evaluated and passed to the linked operation.
