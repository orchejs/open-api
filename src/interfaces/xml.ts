 ...
 *
 * source: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#xmlObject
 */
export interface Xml {
  /**
   * Replaces the name of the element/attribute used for the described schema property.
   * When defined within items, it will affect the name of the individual XML elements within
   * the list. When defined alongside type being array (outside the items), it will affect the
