 ...
 *
 * source: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#encodingObject
 */
export interface Encoding {
  /**
   * The Content-Type for encoding a specific property. Default value depends on the property type:
   * for string with format being binary – application/octet-stream; for other primitive types –
   * text/plain; for object - application/json; for array – the default is defined based on the
   * inner type. The value can be a specific media type (e.g. application/json), a wildcard media
   ...
   * in this section. This property SHALL be ignored if the request body media type is
   * not a multipart.
   */
